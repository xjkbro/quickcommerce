...
export default function Admin() {
    ...
    // if (session.user)
    return (
        <main className="md:w-3/4 mx-auto my-8">
            <div className="flex flex-row rounded-lg border border-gray-200/80 bg-white p-6">
                <div className="relative md:mb-0 mb-12">
                    ...
                    <div
                        className="hidden absolute -right-3 bottom-5 h-5 w-5 sm:top-2 rounded-full border-4 border-white bg-green-400 sm:invisible md:visible"
                ...
                <div className="flex flex-col px-6">
                    <div className="flex h-8 flex-row">
                        <a href="https://github.com/xjkbro/" target="_blank">
                    ...
                    <div className="my-2 flex flex-col md:flex-row mt-12 md:mt-2">
                    ...
                    <div className="mt-2 hidden md:flex flex-row items-center space-x-5">
                        <a
                            href="#"
                ...
                <div className="w-100 hidden md:flex flex-grow flex-col items-end justify-start">
